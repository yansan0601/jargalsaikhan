            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-danger"href="{{route('niitlels.create')}}" >
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    @foreach($niitlels as $niitlel)
                      <a href="{{route('niitlels.show',$niitlel->id)}}">
                        <div class="row list">
                          <div class="col-sm-3"> <img src="{{ asset('images/' . $niitlel->image ) }}" class="custom-img"></div>
                          <div class="col-sm-3">{{ Str::limit($niitlel->title, 50)}}</div>
              ...
              <div class="card-footer clearfix text-xs-center">
                <div class="pagination__wrapper">
                  <ul class="pagination">
                  {{ $niitlels->appends(['sort' => 'votes'])->links() }}
                  </ul>
                </div>
              </div>
            </div>
